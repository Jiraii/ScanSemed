...
with open('web-frontend-source/src/app/app.component.html', 'r', encoding='utf8') as f:
    content = f.read()

index = content.find('<!-- Stock Warning Modal -->')
if index == -1:
    print('Not found')
    sys.exit(1)
...
content = content[:index] + new_html
with open('web-frontend-source/src/app/app.component.html', 'w', encoding='utf8') as f:
    f.write(content)
